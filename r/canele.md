...
- **Gluten-free:** canelés barely rely on gluten — structure comes from egg and starch, and the long rest exists mainly to *relax* gluten — so they convert cleanly, and GF versions are well documented. Swap the AP flour 1:1 for fine white rice flour (the cornstarch is already gluten-free); no xanthan gum needed (a canelé doesn't want stretch, and gums turn it gummy). Bakers report rice flour bakes a touch **chewier/mochi-like**, and since there's no gluten to relax you can shorten or skip the long rest. For a more *tender*, nutty crumb instead, almond flour is a proven alternative. Use a fine grind so it isn't gritty; the shell still crisps and browns normally.
